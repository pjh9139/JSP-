...
<body>
	<p><br/><p>
  <div class="container">
  	<form name="myform" method="post" action="${ctp}/company_update.log" class="was-validated">
	    <h2>계약회사 정보 수정</h2>
	    <br/>
	    ...
	    <div class="form-group">
	      ...
	      <input type="text" class="form-control" id="country" name="country" value="${vo.country}" required />
	    </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
	      ...
	      <input type="text" class="form-control" id="email" name="email" value="${vo.email}" required />
	    </div>
	    <div class="form-group">
	      <label for="tel">전화번호 :</label>
	      <input type="text" class="form-control" id="tel" name="tel" value="${vo.tel}" required />
	    </div>
	    <div class="form-group">
	      <label for="fax">팩스번호 :</label>
	      <input type="text" class="form-control" id="fax" name="fax" value="${vo.fax}" required />
	    </div>
