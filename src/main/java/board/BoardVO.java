...
public class BoardVO {
	...
	public String toString() {
		return "BoardVO [idx=" + idx + ", name=" + name + ", title=" + title + ", content=" + content + ", wDate=" + wDate
				+ ", readNum=" + readNum + ", good=" + good + ", id=" + id + ", day_diff=" + day_diff + ", hour_diff="
				+ hour_diff + ", preIdx=" + preIdx + ", nextIdx=" + nextIdx + ", preTitle=" + preTitle + ", nextTitle="
				+ nextTitle + ", replyCount=" + replyCount + ", photo=" + photo + "]";
	}
